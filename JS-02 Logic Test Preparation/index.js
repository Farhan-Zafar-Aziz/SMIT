...
// console.log("You would eat total of " + totalAmount + " " + favoriteSnack + " for the rest of your life.");
...
// let index = fruits.at(2);
// console.log(index);

// let joinArry = fruits.join();
// console.log(joinArry);
...
// let deleteArry = delete fruits[2];
...
//         document.write(`${num1} ${operators} ${num2} = ${result}`)
